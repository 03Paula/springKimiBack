...
import com.api.kimi.dto.converter.UsuarioDTOConverter;
import com.api.kimi.error.Usuario.UsuarioNotFoundException;
import com.api.kimi.error.Usuario.EmailDuplicatedException;
...
public class UsuarioServiceImp implements UsuarioService {
    ...
    public Iterable<UsuarioDTO> findAll(){
        List<UsuarioDTO> dtoList = usuarioRepository.findAll().stream().map(usuarioDTOConverter::convertToDTO).collect(Collectors.toList());
    ...
    public Optional<UsuarioDTO> findById(Long id) {
        return  usuarioRepository.findById(id).map(usuarioDTOConverter::convertToDTO);
    }
    ...
    public Optional<UsuarioDTO> findClientByEmail(String email) {
        return usuarioRepository.findByEmail(email).map(usuarioDTOConverter::convertToDTO);
    }
